...
import resourceTypes from './azureResourceTypes.json';
  ...
  return (
    <Combobox value={selectedType} onChange={setSelectedType}>
      <div className="relative">
        <Combobox.Input className="w-full border p-2 rounded" onChange={(event) => setQuery(event.target.value)} displayValue={(key) => Object.entries(resourceTypes).find(([k, v]) => v === key)?.[0] || ''} placeholder="Suche Ressourcentyp..." />
