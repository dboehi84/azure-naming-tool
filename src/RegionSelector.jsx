...
import regions from './azureRegions.json';
  ...
  return (
    <Combobox value={selectedRegion} onChange={setSelectedRegion}>
      <div className="relative">
        <Combobox.Input className="w-full border p-2 rounded" onChange={(event) => setQuery(event.target.value)} displayValue={(code) => regions[code] || ''} placeholder="Suche Region..." />
